...
export default function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 flex border-t border-gray-200 bg-white/95 backdrop-blur-md px-4 pb-6 pt-2 shadow-lg">
      <a className="flex flex-1 flex-col items-center justify-center gap-1" style={{ color: BLUE }} href="#">
        <span className="material-symbols-outlined fill-1">home</span>
        <p className="text-[10px] font-bold uppercase tracking-widest">Home</p>
      </a>
      <a className="flex flex-1 flex-col items-center justify-center gap-1 text-gray-400" href="#">
