// plus1-rewards/src/pages/ShopLogin.tsx
      ...
      <div className="flex min-h-screen">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-between p-12 overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            ...
            <img 
              alt="Shop owner managing business" 
              className="w-full h-full object-cover" 
              data-alt="Shop owner using tablet for business management" 
          ...
          <div className="relative z-20 max-w-lg">
            <h1 className="text-5xl font-black leading-tight tracking-tight text-white mb-6">
              Grow your business with <span className="text-primary italic">customer</span> rewards.
            </h1>
            <p className="text-xl text-slate-300 leading-relaxed">
              Attract loyal customers and increase sales with our innovative rewards program designed for local businesses.
            </p>
          </div>
          <div className="relative z-20 flex gap-8">
            <div className="flex flex-col">
              <span className="text-primary text-2xl font-bold">3%</span>
              <span className="text-slate-400 text-sm">Customer Rewards</span>
            </div>
            <div className="flex flex-col">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 bg-background-light dark:bg-background-dark border-l border-white/5">
          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <div>
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white">Shop Owner Login</h2>
              <p className="mt-2 text-slate-600 dark:text-slate-400">Access your business dashboard and manage customer rewards.</p>
            </div>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-sm font-semibold text-slate-700 dark:text-slate-300 ml-1" htmlFor="email">Shop Email Address</label>
              ...
              <button 
                ...
                disabled={loading}
              >
                {loading ? 'Signing in...' : 'Access Shop Dashboard'}
            ...
            <p className="text-center text-slate-600 dark:text-slate-400 mt-8">
              Don&apos;t have a shop account? <a onClick={() => handleNavigation('/shop/register')} className="text-primary font-bold hover:underline cursor-pointer">Register Your Shop</a>
            </p>
          </div>
        </div>
      </div>
