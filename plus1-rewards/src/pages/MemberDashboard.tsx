          ...
          <div className="space-y-4">
            ...
            {mainCoverPlan.status === 'in_progress' && (
              <>
                ...
                {/* Cashback Balance Breakdown - Show even in progress */}
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-blue-700">Allocated to Plan:</span>
                  ...
                  {overflowBalance > 0 && (
                    <div className="border-t border-blue-300 pt-2 mt-2">
                      ...
                      <p className="text-xs text-blue-700 mt-1">
                        💡 Overflow will be available for upgrades once your plan is active
                      </p>
                    </div>
                  )}
                  ...
                  {overflowBalance === 0 && (
                    <div className="border-t border-blue-300 pt-2 mt-2">
                      <p className="text-xs text-blue-700">
                        Keep shopping! Any cashback beyond R{targetAmount.toFixed(2)} becomes overflow
                      </p>
                    </div>
                  )}
                </div>
